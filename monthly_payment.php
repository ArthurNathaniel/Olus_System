...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Fetch total money gained for each payment method on the selected month
    ...
    <div class="history_all">
        ...
        <div class="forms">
            ...
            <form method="POST" action="">
                <div class="forms">
                    <label for="date">Select Month-Year:</label>
                    <input type="month" id="date" name="date" value="<?php echo htmlspecialchars($date); ?>" required>
                </div>
                <div class="forms">
